(() => {
  ...
  // extensions/variant-add-action/src/ActionExtension.jsx
  ...
  // node_modules/@shopify/ui-extensions/build/esm/surfaces/admin/components/ChoiceList/ChoiceList.mjs
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/admin/components/ChoiceList/ChoiceList.mjs
  ...
  var TARGET = "admin.product-variant-details.action.render";
  var ActionExtension_default = reactExtension(TARGET, () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(App, {}));
  function App() {
    const { i18n, close, data } = useApi(TARGET);
    const [productTitle, setProductTitle] = (0, import_react14.useState)("");
    const [variantSKU, setVariantSKU] = (0, import_react14.useState)("");
    const [ebayResults, setEbayResults] = (0, import_react14.useState)([]);
    const [shopName, setShopName] = (0, import_react14.useState)("");
    const [loading, setLoading] = (0, import_react14.useState)(true);
    const [error, setError] = (0, import_react14.useState)("");
    const [selectedId, setSelectedId] = (0, import_react14.useState)("");
    (0, import_react14.useEffect)(() => {
      const fetchShopDetails = () => __async(this, null, function* () {
        try {
          const shopQuery = {
            query: `query {
            shop {
          ...
          const res = yield fetch("shopify:admin/api/graphql.json", {
            ...
            headers: {
              ...
              // Ensure you pass the correct token here
            },
            body: JSON.stringify(shopQuery)
          });
          if (!res.ok)
            throw new Error("Network error while fetching shop details");
          const shopData = yield res.json();
      ...
      const fetchVariantInfo = () => __async(this, null, function* () {
        try {
          ...
          if (!res.ok)
            throw new Error("Network error while fetching variant info");
          const variantData = yield res.json();
          ...
          const ebayRes = yield fetch(`api/admin-ebay-search?title=${variantData.data.productVariant.product.title}`);
          if (!ebayRes.ok)
            throw new Error("Network error while fetching eBay results");
          const ebayData = yield ebayRes.json();
    ...
    const handleSave = () => __async(this, null, function* () {
      ...
      try {
        const res = yield fetch("/api/update-product-url", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ sku: variantSKU, newUrl: selectedId, shop: shopName })
          // Use the selected ID
        });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      AdminAction2,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
          ...
          loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Loading..." }) : error ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { status: "critical", children: error }) : ebayResults.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            ChoiceList2,
            {
              title: "eBay Products",
              selected: selectedId ? [selectedId] : [],
              onChange: handleSelectEbayItem,
          ...
          ) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { status: "info", children: "Nothing to show here, Try again later or use a different product" })
        ] })
      }
    );
  }
})();
//# sourceMappingURL=Search-Ebay.js.map
